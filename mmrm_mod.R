  ...
  tagList(
    sidebarLayout(
      sidebarPanel(
        ...
        numericInput(ns("n"), "Number of Simulations", 5000),
      ...
      mainPanel(
        width = 8,
        tags$style(".small-box.bg-yellow { background-color: #FFCC33 !important; 
          ...
          tabPanel(title = "Experimental Design", 
                   ...
                   fluidRow(
                     ...
                     column(12, 
                            ...
                            column(5, align="left", 
                                   shinydashboard::valueBoxOutput(ns("simulationPower"), 
                                                                  width = 8))
                     ),
                     br(),
                     column(12, 
                            column(4, numericInput(ns("mu"), "Baseline Mean", 38, min = 0)),
                            column(4, numericInput(ns("sd"), "Common SD", 10.5, min = 0)),
                            column(4, numericInput(ns("corr"),"Corr Among Visits", 
                                                   0.5, min = -1, max = 1))),
          ...
          tabPanel("Simulated Data",
                   ...
                   fluidRow(
                     ...
                     column(12, align="center", 
                            tags$p("A Trial of Simulated Data",
                            style = "width:50%;background-color:#FFCC33; color:#0C5449; 
                     ...
                     br(),
                     br(),
                     column(12, align="center", downloadButton(ns("downloadData"), 
                                                               "Download Data", class = "butt"))
                   )
          )
        )
      )
...
mod_server <- function(id) {
  ...
  moduleServer(id, function(input, output, session) {
    ...
    #Dynamically generated Input elements for post baseline visits 
    shinyjs::useShinyjs()
    output$fu <- renderUI({
            ...
            column(
              ...
              div(class = "input",
                  sliderInput(inputId = ns(paste0("et.rate.trt.fu",i)),
                              label = paste("TRT ET Rate", i),value = (4-i)*0.05,
                              min = 0, max = 0.5, step=0.01)
              ),
              div(class = "input",
                  sliderInput(inputId = ns(paste0("et.rate.pbo.fu", i)),
                              label = paste("PBO ET Rate", i), value = (4-i)*0.03,
                              min = 0, max = 0.5, step = 0.01)
              ),
              div(class = "input",
    ...
    observeEvent(input$runSim, {
      withProgress(message = "Generating Data", value=0, {
        ...
        #Display the first trial of simulated data.
